...
interface Props {
  ...
  handleSubmit: (arg0: { history: any, user: User, gameNiceId: TGameNiceId, }) => void;
  getIinitials: (firstName: string, lastName: string) => string;
  openTheLobby: (gameNiceId: TGameNiceId, status: string, history: any) => void;
...
const PoppapToLobby = (props: Props): JSX.Element => {
  ...
  const onFormSubmit = (
    ...
    openTheLobby(gameNiceId, 'lobby', history);
    setSubmitting(false);
  };
